...
You can install the released version of SimpLogo from Github using the devtools package:
...
```{r fig2, fig.align = "center", dpi=300, echo = FALSE}
plot$primary.plot
```
...
```{r fig3, fig.height = 2, fig.align = "center", dpi=300, echo = FALSE}
plot$ic.plot
```
...
```{r fig4, fig.align = "center", dpi=300, echo = FALSE}
plot$final.plot
```
...
```{r fig5, fig.align = "center", dpi=300}
## now plot
plot$primary.plot + 
...
```{r fig6, fig.align = "center", dpi=300}
...
```{r fig7, fig.align = "center", dpi=300}
...
```{r fig9, fig.align = "center", dpi=300}
results2 <- results
